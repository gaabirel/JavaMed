...
public class ConsultaDAO {
    ...
    public ConsultaDAO() {
        this.nomeArquivo = Config.CAMINHO_CONSULTAS;
    }
    ...
    */
    public void salvarUnico(Consulta consulta) throws IOException{
        ...
        boolean Vcon = verificarConsultaId(consulta.getIdConsulta());
        boolean Vpac = pacienteDAO.verificarRegistroID(consulta.getPaciente()) ;
        boolean Vmed = medicoDAO.verificarRegistroID(consulta.getMedico());
