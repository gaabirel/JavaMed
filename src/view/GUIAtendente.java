...
public class GUIAtendente extends JFrame implements ActionListener {
    ...
    public GUIAtendente(String nomeAtendente) {
        ...
        botaoMarcarConsulta.setFont(new Font("Arial", Font.BOLD, 24));
        ...
        botaoExcluirPaciente.setFont(new Font("Arial", Font.BOLD, 24));
        ...
        botaoRegistrarPaciente.setFont(new Font("Arial", Font.BOLD, 24));
        ...
        botaoVerConsultas.setFont(new Font("Arial", Font.BOLD, 24));
        ...
        botaoListarPacientes.setFont(new Font("Arial", Font.BOLD, 24));
        ...
        botaoAlterarPaciente.setFont(new Font("Arial", Font.BOLD, 24));
        ...
        if (e.getSource() == botaoMarcarConsulta) {
            ...
            try {
                while(consultaController.verificarConsultaId(Integer.parseInt(idConsulta))){
                    idConsulta = JOptionPane.showInputDialog("Digite um ID da consulta que não exista:");
                }
