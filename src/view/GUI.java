...
public class GUI extends JFrame implements ActionListener {
    ...
    ConsultaController consultaController;
        ...
        // Criando os objetos dos controllers
        ...
        this.setSize(650, 650); // Configurando as dimensoes do frame
        ...
        labelCentral.setFont(new Font("Arial", Font.BOLD, 36)); // Setando uma fonte a label
        labelCentral.setIcon(new ImageIcon("JavaMed/icones/medical-symbol.png"));
        ...
        botaoFuncionario.setFont(new Font("Arial", Font.BOLD, 24));
        botaoFuncionario.setIcon(new ImageIcon("JavaMed/icones/funcionario.png"));
        ...
        botaoPaciente.setFont(new Font("Arial", Font.BOLD, 24));
        botaoPaciente.setIcon(new ImageIcon("JavaMed/icones/patient.png"));
